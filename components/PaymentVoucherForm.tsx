...
import { PaymentVoucher, Currency, Country, LineItem, DiscountType } from '../types/document';
              ...
              <div className="p-4 bg-gray-50 rounded-lg space-y-3">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  {hasDocDiscount && (
                    <span className="text-red-600 ml-auto">
                      -{formData.currency} {totals.documentDiscountAmount.toFixed(2)}
                    </span>
                  )}
                </div>
                ...
                {hasDocDiscount && (
                  <div className="flex justify-between text-sm text-muted-foreground">
                    ...
                    <span>{formData.currency} {totals.discountedSubtotal.toFixed(2)}</span>
                  </div>
                )}
                ...
                {totals.taxAmount > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{formData.currency} {totals.taxAmount.toFixed(2)}</span>
                  </div>
                )}
                <Separator />
                <div className="flex justify-between text-lg">
                  <span className="font-bold">Total:</span>
                  <span className="font-bold">{formData.currency} {totals.total.toFixed(2)}</span>
                </div>
              </div>
            );
          })()}
