...
function dbLineItemToLineItem(dbItem: DbLineItem): LineItem {
  return {
    ...
    discountType: dbItem.discount_type as 'fixed' | 'percentage' | undefined,
    discountValue: dbItem.discount_value || undefined,
    discountAmount: dbItem.discount_amount || undefined,
...
function dbDocumentToInvoice(doc: DbDocument, invoiceData: any, items: DbLineItem[], paymentSummary?: any): Invoice {
  return {
    ...
    documentDiscountType: doc.document_discount_type as 'fixed' | 'percentage' | undefined,
    documentDiscountValue: doc.document_discount_value || undefined,
    documentDiscountAmount: doc.document_discount_amount || undefined,
